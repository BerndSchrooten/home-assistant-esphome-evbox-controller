...
from . import (
    CONF_EVBOX_ID,
    EVBOX_COMPONENT_SCHEMA,
    CONF_TARGET_SOLAR_POWER_CONSUMPTION,
)

CONF_CALCULATED_CURRENT = "calculated_current"
CONF_TARGET_CURRENT = "target_current"
...
TYPES = {
    CONF_CALCULATED_CURRENT: sensor.sensor_schema(
        unit_of_measurement=UNIT_AMPERE,
        accuracy_decimals=1,
        device_class=DEVICE_CLASS_CURRENT,
        state_class=STATE_CLASS_MEASUREMENT,
    ),
    CONF_TARGET_CURRENT: sensor.sensor_schema(
        unit_of_measurement=UNIT_AMPERE,
        accuracy_decimals=1,
        device_class=DEVICE_CLASS_CURRENT,
        state_class=STATE_CLASS_MEASUREMENT,
    ...
    CONF_TARGET_SOLAR_POWER_CONSUMPTION: sensor.sensor_schema(
        state_class=STATE_CLASS_MEASUREMENT, accuracy_decimals=1
    ),
}
